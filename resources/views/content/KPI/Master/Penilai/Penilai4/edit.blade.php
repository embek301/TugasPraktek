...
@section('content')
    <div class="container-sm mt-5">
        <form action="{{ route('penilai4.update', ['penilai4' => $penilai4->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="p-5 rounded-3 border col-xl-6" style="background-color: #d4d5d5;">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="nama_penilai4" class="form-label">Nama penilai4</label>
                            <input class="form-control @error('nama_penilai4')is-invalid @enderror" type="text"
                                name="nama_penilai4" id="nama_penilai4"
                                value="{{ $errors->any() ? old('nama_penilai4') : $penilai4->name }}"
