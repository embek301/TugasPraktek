                ...
                <div class="p-5 rounded-3 border col-xl-6" style="background-color: #d4d5d5;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('tanggal_pengajuan') is-invalid @enderror custom-placeholder"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('jumlah')is-invalid @enderror" type="text" name="jumlah"
                                id="jumlah" value="" readonly>
                            @error('jumlah')
                                <div class="text-danger"><small>{{ $message }}</small></div>
                            @enderror
                        </div>
