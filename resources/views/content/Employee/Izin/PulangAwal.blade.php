        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center text-dark">
                <div class="p-5 rounded-3 border col-xl-6" style="background-color: #d4d5d5;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="id_pulangAwal" class="form-label">no</label>
                            <input class="form-control" type="text" name="id_pulangAwal" id="id_pulangAwal"
                                value="{{ $idPulangAwal }}" readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('tanggal') is-invalid @enderror custom-placeholder"
                                type="date" name="tanggal" id="tanggal" value="{{ $dateInGMTPlus7->format('Y-m-d') }}"
                                readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="waktu" class="form-label">Waktu</label>
                            <input class="form-control @error('waktu') is-invalid  @enderror custom-placeholder"
                                type="text" name="waktu" id="waktu" value="{{ $dateInGMTPlus7->format('H:i:s') }}"
                                readonly>
                        </div>
                        <div class="col-md-6 mb-3">
