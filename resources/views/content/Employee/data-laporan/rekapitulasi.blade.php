            ...
            <script type="module">
                $(document).ready(function() {
                    ...
                    $('#filter-btn').click(function() {
                        ...
                        $.ajax({
                            url: '{{ route('filter-Rekapitulasi') }}', // Ganti dengan nama route yang sesuai
                            type: 'GET',
                            data: {
                    ...
                    $('#export-excel-button').click(function() {
                        ...
                        window.location.href = '{{ route('export.excel.Rekapitulasi') }}' + '?tanggal_awal=' +
                            tanggalAwal +
                    ...
                    $('#export-pdf-button').click(function() {
                        ...
                        window.location.href = '{{ route('export.pdf.Rekapitulasi') }}' + '?tanggal_awal=' +
                            tanggalAwal +
                            '&tanggal_akhir=' + tanggalAkhir + '&cabang=' + cabang;
                    });
                });
