            ...
            <script type="module">
                $(document).ready(function() {
                    ...
                    $('#filter-btn').click(function() {
                        ...
                        $.ajax({
                            url: '{{ route('filter-Sakit') }}', // Ganti dengan nama route yang sesuai
                            type: 'GET',
                            data: {
                            ...
                            success: function(response) {
                                ...
                                $.each(response.data, function(index, terlambat) {
                                    ...
                                    var newRow = '<tr>' +
                                        ...
                                        '<td>' + formatDate(terlambat.tgl_akhir) + '</td>' +
                    ...
                    $('#export-excel-button').click(function() {
                        ...
                        window.location.href = '{{ route('export.excel.Sakit') }}' + '?tanggal_awal=' +
                            tanggalAwal +
                    ...
                    $('#export-pdf-button').click(function() {
                        ...
                        window.location.href = '{{ route('export.pdf.Sakit') }}' + '?tanggal_awal=' +
                            tanggalAwal +
                            '&tanggal_akhir=' + tanggalAkhir + '&cabang=' + cabang;
                    });
                });
