...
class LaporanTerlambat extends Controller
{
    /**
    ...
    {
        $pageTitle = 'Data Laporan Izin Terlambat';
        $user = auth()->user();
        $userName = $user->who;
        ...
        $tanggalAkhir = '';
        $cabang = '';
        return view('content.Employee.data-laporan.izin-terlambat', compact('pageTitle', 'isPenilai2', 'terlambatData', 'cabs', 'tanggalAwal', 'tanggalAkhir', 'cabang'));
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new TerlambatExport($judul, $terlambatData), $filename);
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('content.Employee.data-laporan.pdf.pdfTerlambat', compact('terlambatData', 'bulan', 'jenisLaporan'))->setPaper('a4');
