...
class CutiTerencana extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pageTitle = 'Form Izin Cuti Terencana';
        $user = auth()->user();
        $userName = $user->who;
        ...
        $pengganti = User::where('dept', $departemenPengguna)
            ...
            ->get();
        // dd($pengganti);
        return view('content.Employee.izin.CutiTerencana', compact('pageTitle', 'users', 'dateInGMTPlus7', 'idClockOut', 'isWithinAllowedTime', 'isPenilai2', 'pengganti', 'isPengganti'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $terlambat->jenis = "Izin Cuti Terencana";
            ...
            if ($PenggantiMail) {
                ...
                Mail::to($PenggantiMail)->send(new CutiTerencanaMail($terlambat));
