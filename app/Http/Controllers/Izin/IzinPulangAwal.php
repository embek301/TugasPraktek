...
class IzinPulangAwal extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.Employee.izin.pulangawal', compact('pageTitle', 'users', 'dateInGMTPlus7', 'idPulangAwal', 'isWithinAllowedTime', 'isPenilai2'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $terlambat->alasan = $request->alasanPulang;
            $penilai2Name = auth()->user()->penilai2;
            $terlambat->last = $penilai2Name;
            $terlambat->jenis = "Izin Pulang Awal";
            ...
            if ($penilai2Mail) {
                ...
                Mail::to($penilai2Mail)->send(new IzinPulangAwalNotification($terlambat));
